...
(function () {
  ...
  function showBanner() {
    ...
    b.innerHTML =
      '<div class="ck__txt"><b>A word on cookies.</b> Essential cookies keep the site working; with your consent we also use analytics cookies to improve it. Read our <a href="/entwine/cookies">Cookie Policy</a>.</div>' +
      '<div class="ck__btns">' +
